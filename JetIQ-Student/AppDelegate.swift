...
class AppDelegate: UIResponder, UIApplicationDelegate, UISplitViewControllerDelegate, UITabBarControllerDelegate {
    ...
    {
        #if !DEBUG
        MSAppCenter.start("e1ebf11f-f971-433a-9160-4363297a0f00", withServices:[ MSAnalytics.self, MSCrashes.self ])
        #endif
...
//    }
    ...
    func application(_ application: UIApplication,
        ...
        coder.encode(Bundle.main.releaseVersionNumber, forKey: "AppVersion")
    ...
    func application(_ application: UIApplication,
        ...
        let version = coder.decodeObject(forKey: "AppVersion") as! String
...
//        guard let topAsDetailController = secondaryAsNavController.topViewController as? SettingsDetailViewController else { return false }
...
//    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "JetIQ_Student")
